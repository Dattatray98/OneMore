            ...
            <div className="container mx-auto px-4 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-4">
                    {isAuthenticated ? (
                        ...
                        <Link
                            to="/app"
                            className="px-8 py-2.5 bg-linear-to-r from-cyan-600 to-blue-600 text-white rounded-full font-bold text-sm hover:shadow-lg hover:shadow-cyan-500/20 hover:scale-105 transition-all cursor-pointer"
                        >
                            Sign In
                        </Link>
                    )}

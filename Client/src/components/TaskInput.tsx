        ...
        <form onSubmit={handleSubmit} className="relative w-full max-w-2xl mb-8 group">
            ...
            <div className="relative flex items-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl overflow-hidden p-1 shadow-xl dark:shadow-none">
                <input
                    ...
                    className="w-full bg-transparent text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 px-6 py-4 text-lg outline-none"
                />
                <button
                    type="submit"
                    disabled={!text.trim()}
                    className="px-6 py-3 bg-cyan-600 hover:bg-cyan-500 text-white rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 cursor-pointer"
                >
                    <Plus size={20} />
                ...
                {onAdvancedAdd && (
                    <button
                        ...
                        className="px-4 py-3 text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-400 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors border-l border-slate-100 dark:border-white/5 cursor-pointer"
